document.addEventListener('DOMContentLoaded', function () {
    ...
    // Only run customization code if we're on the customization page
    const submitButton = document.getElementById('submit-button');
    const resetButton = document.getElementById('reset-button');
    const customizationContainer = document.querySelector('.customized-container');
    ...
    if (customizationContainer) {
        ...
        if (resetButton) {
            resetButton.addEventListener('click', (e) => {
                ...
                if (sizesSelect) {
                    sizesSelect.innerHTML = '<option value="" disabled selected>Select one</option>';
                }
