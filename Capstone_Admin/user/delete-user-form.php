...
<script src="dashboard.js"></script>
        ...
        // CREATE THE QUERY TO SELECT RECORD FROM tbl_user_info TABLE WHERE User_ID MATCHES
        if (isset($_GET['id'])) {
...
<div class="container_boxes">
    <form name="frmUserRec" method="POST" action="delete-user-rec.php">
        ...
        <div class="button-container">
            ...
            <a href="delete-user-rec.php?id=<?php echo htmlspecialchars($userID); ?>" target="_parent" class="buttonDelete">Delete Record</a>
        </div>
    </form>
</div>
